...
!!! success "Wir danken allen Teilnehmer\*Innen sowie unseren Gastgeber\*Innen von der [Folkwang Universität der Künste](https://www.folkwang-uni.de/) für eine tolle Veranstaltung!"
...
Wie immer war das eigentlich wichtige an der Fab:UNIverse der direkte, persönliche, bestärkende und informierende Austausch zwischen Menschen, die Makerspaces und Fab Labs machen. Wie jedes Jahr war es außerdem spannend, Details über die ganz unterschiedlichen Entwicklungsstände der beteiligten Labs und Spaces zu erfahren. Daneben haben wir uns strukturierter über folgende Themen ausgetauscht: 

- Das Makerspace-Management-System [FabAccess](https://www.fab-access.info), mit dem unter anderem Zugang zu Geräten kontrolliert und abgerechnet werden kann. 

- [Visicut](https://visicut.org), ein Werkzeug, mit dem Jobs für Lasercutter vorbereitet und organisiert werden können. Dies auch mit Kamera-Unterstützung und Teilen von Materialprofilen.

- Die Website für Fab:UNIverse unter [fab-universe.de](https://fab-universe.de). Sie wird gemeinschaftlich weiterentwickelt. Contributions welcome!

- Eine Projektidee aus der [BURG](https://www.burg-halle.de/hochschule/einrichtungen/zentrale-werkstaetten/) zum gemeinsamen Sammeln und Teilen von Maschinen-Einstellungen. Contributions welcome! 

Sehr beschäftigt hat uns wie immer auch das Thema **Bildung**. Wir haben insbesondere über Lehr-/Lernformate, MINT/STEAM und die Schule diskutiert und viele Beispiele und Erfahrungen weitergegeben.   

In Form eines großen runden Tisches haben wir vertrauensvoll über **Herausforderungen** gesprochen. Politik, Macht, Spannungsfelder zwischen Verwaltung und Community und das große (Dauer-)Thema "Offenheit Offener Werkstätten" haben uns beschäftigt.  

Auch **über die Fab:UNIverse selbst** haben wir uns ausgetauscht. Unter andere darüber, wie die Tagung organisiert und verstetigt werden kann. Im Ergebnis möchten wir uns weiterhin so unabhängig und flexibel wie möglich halten. Dennoch gibt es ein Mandat für Interessierte, sich mit Möglichkeiten zur Organisationsentwicklung zu beschäftigen und auf der nächsten Tagung zu berichten. Es soll dazu sowohl mit einzelnen Community-Mitgliedern gesprochen werden, als auch der Dialog mit dem Verbund Offener Werkstätten weiter ausgebaut werden. Der VOW hat sich im Rahmen einer Live-Schaltung auch ausführlich vorgestellt und z.B. auf seine Angebote im Bereich Wissensaustausch und Versicherung hingewiesen, die gerade auch für Hochschulen von Wichtigkeit sind.


#### Wer war dabei?

Vertreten waren die Makerspaces und Fab Labs folgender Hochschulen sowie folgende Organisationen:
...
Diese Liste ist möglicherweise unvollständig und freut sich über Ergänzungen. 

A propos "Liste": Dank einer engagierten Person aus unserer Community gibt es eine aktualisierte [Übersicht von Fab Labs und Makerspaces an Hochschulen in Deutschland](labs.md). Auch diese Liste kann sehr gern ergänzt werden. 
...
??? info "Mehr über die Folkwang Universität und das Projekt SBYD"
    ...
    Mit dem [Advanced Technology Lab](https://id.folkwang-uni.de/werkstatten/advanced-technology-lab/) (ATL) betreibt die Folkwang Universität ein bewusst an das Konzept der Fab Labs angelehntes Labor inmitten ihrer "regulären", disziplinär strukturierten [Werkstätten](https://id.folkwang-uni.de/werkstatten/).
