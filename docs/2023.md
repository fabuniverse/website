...
**WS3:** *Special Interest Group Visicut:* Einführung in [VisiCut](https://visicut.org/) sowie Arbeit an und Diskussion um die (Weiter-)Entwicklung von VisiCut. Organisation: [Jan Borchers](https://hci.rwth-aachen.de/borchers), [Anke Brocker](https://hci.rwth-aachen.de/brocker) und [Maximilian Gaukler](https://www.offene-werkstaetten.org/users/profile/1076).
...
- Eine Anreise aus Bochum ist gut machbar, sodass Hotelreservierungen nicht geändert werden müssen.
